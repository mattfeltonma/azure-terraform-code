...
variable "workload_vnet_resource_group_id" {
  description = "The workload virtual network resource id. The AI Foundry resource must be deployed to the same resource group as the virtual network it will use for the Standard Agent Virtual Network Injection"
  type        = string
}

variable "workload_vnet_resource_group_name" {
  description = "The workload virtual network resource name. The AI Foundry resource must be deployed to the same resource group as the virtual network it will use for the Standard Agent Virtual Network Injection"
  type        = string
}