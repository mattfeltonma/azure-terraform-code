locals {
  ...
  vnet_cidr_tr_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 1)
  vnet_cidr_ss_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 2)
  vnet_cidr_wl1_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 3)
  vnet_cidr_wl2_pri = cidrsubnet(var.address_space_azure_primary_region, 2, 4)
  ...
  vnet_cidr_tr_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 1), null) : null 
  vnet_cidr_ss_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 2), null) : null
  vnet_cidr_wl1_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 3), null) : null
  vnet_cidr_wl2_sec = var.multi_region == true ? try(cidrsubnet(var.address_space_azure_secondary_region, 2, 4), null) : null
