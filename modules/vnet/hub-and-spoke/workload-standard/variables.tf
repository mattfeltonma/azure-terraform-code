...
variable "subnet_cidr_amlcpt" {
  description = "The address space to assign to the subnet used for Azure Machine Learning vnet injected compute"
  type        = string
}
...
variable "workload_number" {
  description = "The number of the workload"
  type        = string
  default     = 1
}
