...
output "network_security_group_id_app" {
  value       = module.nsg_app.id
  description = "The resource id of the network security group for the application subnet"
}

output "network_security_group_id_svc" {
  value       = module.nsg_svc.id
  description = "The resource id of the network security group for the services subnet"
}
